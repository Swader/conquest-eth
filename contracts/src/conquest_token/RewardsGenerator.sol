...
contract RewardsGenerator is IERC20, Proxied, IOnStakeChange {
    ...
    constructor(
        ...
        postUpgrade(rewardAddress, config, initialGames, initialAccounts);
    }
    ...
    function _updateAccount(address account, uint256 totalRewardPerPointAllocatedSoFar)
        internal
        returns (uint256 accountPointsSoFar)
    {
